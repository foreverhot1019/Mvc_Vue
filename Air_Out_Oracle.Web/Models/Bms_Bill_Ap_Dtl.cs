...
{
    //应付帐单明细
    public partial class Bms_Bill_Ap_Dtl : Entity
    {
        public Bms_Bill_Ap_Dtl()
        {
        ...
        [Display(Name = "应付帐单Id", Description = "")]
        public int? Bms_Bill_Ap_Id { get; set; }

        [ForeignKey("Bms_Bill_Ap_Id")]
        [Display(Name = "应付帐单", Description = "")]
        public virtual Bms_Bill_Ap OBms_Bill_Ap { get; set; }

        [Index("UQ_BmsBillApDtl", IsUnique = true, Order = 1)]
        [Display(Name = "业务编号", Description = "")]
        [MaxLength(50)]
        public string Dzbh { get; set; }

        [Index("UQ_BmsBillApDtl", IsUnique = true, Order = 2)]
        [Display(Name = "序号")]
        public int Line_No { get; set; }

        [Index("UQ_BmsBillApDtl", IsUnique = true, Order = 3)]
        [Display(Name = "明细序号")]
        public int Line_Id { get; set; }

        [Index("IX_ApDtl_CHCode", IsUnique = false, Order = 1)]
        ...
        [Index("BmsBillApDtl_Status", IsUnique = false, Order = 1)]
        ...
        [Index("BmsBillApDtl_OP", IsUnique = false, Order = 1)]
