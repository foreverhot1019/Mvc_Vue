...
namespace AirOut.Web.Models
{
    public class WebdbContext : DataContext
    {
            ...
            : base("Name=DefaultConnection")
        {
            ...
            IsWriteDataToLunece = AirOut.Web.Extensions.Common.ChangStrToBool(IsWriteDataToLuneceStr);
            ...
            bool IsWriteDataToRedis = AirOut.Web.Extensions.Common.ChangStrToBool(IsWriteDataToRedisStr);
        ...
        public DbSet<BaseCode> BaseCode { get; set; }
        ...
        public virtual DbSet<PARA_Tables> PARA_Tables { get; set; }

        public virtual DbSet<PARA_CURR> PARA_CURR { get; set; }

        public virtual DbSet<PARA_Country> PARA_Country { get; set; }

        public virtual DbSet<PARA_Customs> PARA_Customs { get; set; }

        public virtual DbSet<PARA_Area> PARA_Area { get; set; }

        public virtual DbSet<PARA_AirPort> PARA_AirPort { get; set; }

        public virtual DbSet<PARA_Package> PARA_Package { get; set; }

        public virtual DbSet<PARA_AirLine> PARA_AirLine { get; set; }

        public virtual DbSet<DailyRate> DailyRate { get; set; }

        public virtual DbSet<Rate> Rate { get; set; }

        public virtual DbSet<CusBusInfo> CusBusInfo { get; set; }

        public virtual DbSet<CostMoney> CostMoney { get; set; }

        public virtual DbSet<QuotedPrice> QuotedPrice { get; set; }

        public virtual DbSet<CustomerQuotedPrice> CustomerQuotedPrice { get; set; }

        public virtual DbSet<CusQuotedPriceDtl> CusQuotedPriceDtl { get; set; }

        public virtual DbSet<FeeType> FeeType { get; set; }

        public virtual DbSet<FeeUnit> FeeUnit { get; set; }

        public virtual DbSet<DealArticle> DealArticle { get; set; }

        #region 承揽接单表

        public virtual DbSet<OPS_EntrustmentInfor> OPS_EntrustmentInfor { get; set; }

        public virtual DbSet<OPS_M_Order> OPS_M_Order { get; set; }

        public virtual DbSet<OPS_H_Order> OPS_H_Order { get; set; }

        //public virtual DbSet<OPS_M_H_Relation> OPS_M_H_Relation { get; set; }

        #endregion

        #region 报关报检 

        public virtual DbSet<CustomsInspection> CustomsInspection { get; set; }
        ...
        public virtual DbSet<Warehouse_Cargo_Size> Warehouse_Cargo_Size { get; set; }
        ...
        public virtual DbSet<Bms_Bill_Ap> Bms_Bill_Ap { get; set; }

        public virtual DbSet<Bms_Bill_Ap_Dtl> Bms_Bill_Ap_Dtl { get; set; }

        public virtual DbSet<Bms_Bill_Ar> Bms_Bill_Ar { get; set; }

        public virtual DbSet<Bms_Bill_Ar_Dtl> Bms_Bill_Ar_Dtl { get; set; }

        #endregion

        public virtual DbSet<CoPoKind> CoPoKind { get; set; }

        public virtual DbSet<TradeType> TradeType { get; set; }

        public virtual DbSet<Eai_Group> Eai_Group { get; set; }

        public virtual DbSet<PortalEntryIDLink> PortalEntryIDLink { get; set; }

        public virtual DbSet<Saller> Saller { get; set; }

        #endregion

        public virtual DbSet<TestMVC_CRUD> TestMVC_CRUD { get; set; }
        ...
        public override int SaveChanges()
        {
            ...
            try
            {
                ...
                string CurrentUserId = AirOut.Web.Controllers.Utility.CurrentAppUser == null ? "" : AirOut.Web.Controllers.Utility.CurrentAppUser.Id;
                string CurrentUserName = AirOut.Web.Controllers.Utility.CurrentAppUser == null ? "" : AirOut.Web.Controllers.Utility.CurrentAppUser.UserName;
                var CurrentUserOperatePoint = AirOut.Web.Controllers.Utility.CurrentUserOperatePoint ?? new List<OperatePoint>();
                ...
                foreach (var entityitem in _entitiesAdded)
                {
                    ...
                    {
                        SQLDALHelper.WriteLogHelper.WriteLog("全文检索错误（LuneceInsert）：" + AirOut.Web.Extensions.Common.GetExceptionMsg(ex), "LuneceError", true);
                    }
                ...
                foreach (var entityitem in _entitiesChanged)
                {
                    ...
                    {
                        SQLDALHelper.WriteLogHelper.WriteLog("全文检索错误（LuneceModify）：" + AirOut.Web.Extensions.Common.GetExceptionMsg(ex), "LuneceError", true);
                    }
                ...
                foreach (var entityitem in _entitiesChanged)
                {
                    ...
                    {
                        SQLDALHelper.WriteLogHelper.WriteLog("全文检索错误（LuneceDelete）：" + AirOut.Web.Extensions.Common.GetExceptionMsg(ex), "LuneceError", true);
                    }
                }
                try
                {
