...
{
    [MetadataType(typeof(DocumentManagementMetadata))]
    public partial class DocumentManagement
    {
    }

    public partial class DocumentManagementMetadata
    {
        ...
        [Display(Name = "是否退单", Description = "是否退单(海关退单：0:否,1:是)")]
	...
	public class DocumentManagementChangeViewModel
    {
        public IEnumerable<DocumentManagement> inserted { get; set; }

        public IEnumerable<DocumentManagement> deleted { get; set; }

        public IEnumerable<DocumentManagement> updated { get; set; }
    }
}
