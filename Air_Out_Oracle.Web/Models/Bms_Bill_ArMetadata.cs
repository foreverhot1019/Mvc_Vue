...
{
    [MetadataType(typeof(Bms_Bill_ArMetadata))]
    public partial class Bms_Bill_Ar
    {
    }

    public partial class Bms_Bill_ArMetadata
    {
	...
	public class Bms_Bill_ArChangeViewModel
    {
        public IEnumerable<Bms_Bill_Ar> inserted { get; set; }

        public IEnumerable<Bms_Bill_Ar> deleted { get; set; }

        public IEnumerable<Bms_Bill_Ar> updated { get; set; }
    }
}
