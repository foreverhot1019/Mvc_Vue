...
{
    //报价
    public partial class QuotedPrice : Entity
    {
        public QuotedPrice()
        {
        ...
        [Index("IX_QuotedP_Key", IsUnique = true, Order = 1)]
