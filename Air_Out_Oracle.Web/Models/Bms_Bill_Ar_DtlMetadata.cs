...
{
    [MetadataType(typeof(Bms_Bill_Ar_DtlMetadata))]
    public partial class Bms_Bill_Ar_Dtl
    {
    }

    public partial class Bms_Bill_Ar_DtlMetadata
    {
        [Display(Name="应收帐单",Description="应收帐单")]
        ...
        [Display(Name="应收帐单Id",Description="应收帐单Id")]
	...
	public class Bms_Bill_Ar_DtlChangeViewModel
    {
        public IEnumerable<Bms_Bill_Ar_Dtl> inserted { get; set; }

        public IEnumerable<Bms_Bill_Ar_Dtl> deleted { get; set; }

        public IEnumerable<Bms_Bill_Ar_Dtl> updated { get; set; }
    }
}
