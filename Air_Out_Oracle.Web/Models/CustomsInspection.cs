...
{
    //报关报检
    public partial class CustomsInspection : Entity
    {
        ...
        [Display(Name = "托书件数", Description = "托数件数")]
        ...
        [Display(Name = "海关查检次数", Description = "海关查件次数")]
        ...
        [Index("IX_CusInspection_Status", IsUnique = false, Order = 1)]
        [Display(Name = "使用状态", Description = "状态(0:否,1:是)")]
        public AirOutEnumType.UseStatusIsOrNoEnum Status { get; set; }

        [Index("IX_CusInspection_OP", IsUnique = false, Order = 1)]
