...
namespace AirOut.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void InitData()
        {
            ...
            UserManager.AddToRole(ArrAppUser[2].Id, ArrApplicationRole[1].Name);
            ...
            MenuItem PMenuItem = new MenuItem { Id = 1, Title = "系统管理", Code = "000100", Url = "#", IsEnabled = true, Controller = "#", Action = "#", IconCls = "fa fa-gear", ParentId = null };
