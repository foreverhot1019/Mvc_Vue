...
namespace AirOut.Web.Extensions
{
    public static class Common
    {
        ...
        public enum CacheNameS
        {
            ...
            OperatePoint,
            [Display(Name = "PARA_UNIT", Description = "申报单位")]
            PARA_UNIT,
            [Display(Name = "PARA_TRANSF", Description = "运输方式")]
            PARA_TRANSF,
            [Display(Name = "PARA_Customs", Description = "海关-口岸")]
            PARA_Customs,
            [Display(Name = "PARA_TRANSMODE", Description = "成交方式")]
            PARA_TRANSMODE,
            [Display(Name = "PARA_Country", Description = "国家代码")]
            PARA_Country,
            [Display(Name = "PARA_Area", Description = "国内地区")]
            PARA_Area,
            [Display(Name = "PARA_LEVYTYPE", Description = "征免性质")]
            PARA_LEVYTYPE,
            [Display(Name = "BD_CUSTOMSBROKER", Description = "报关行信息")]
            BD_CUSTOMSBROKER,
            [Display(Name = "BD_DEFDOC_LIST", Description = "枚举信息")]
            BD_DEFDOC_LIST,
            [Display(Name = "BD_CUSSERVICES", Description = "客服信息")]
            BD_CUSSERVICES,
            [Display(Name = "BD_CUSTOMER", Description = "客户信息")]
            BD_CUSTOMER,
            [Display(Name = "PARA_CURR", Description = "币制")]
            PARA_CURR,
            [Display(Name = "PARA_Package", Description = "包装类型")]
            PARA_Package,
            [Display(Name = "PARA_TRADE", Description = "监管方式")]
            PARA_TRADE,
            [Display(Name = "Rate", Description = "汇率")]
            Rate,
            [Display(Name = "CusBusInfo", Description = "客商信息")]
            CusBusInfo,
            [Display(Name = "PARA_AirPort", Description = "空港信息")]
            PARA_AirPort,
            [Display(Name = "PARA_AirLine", Description = "航线信息")]
            PARA_AirLine,
            [Display(Name = "DealArticle", Description = "成交条款")]
            DealArticle,
            [Display(Name = "CodeItem", Description = "通用代码")]
            CodeItem,
            [Display(Name = "TradeType", Description = "行业类型")]
            TradeType,
            [Display(Name = "CoPoKind", Description = "企业性质")]
            CoPoKind,
            [Display(Name = "QuotedPrice", Description = "报价数据")]
            QuotedPrice,
            [Display(Name = "CustomerQuotedPrice", Description = "客户报价数据")]
            CustomerQuotedPrice,
            [Display(Name = "CostMoney", Description = "成本报价数据")]
            CostMoney,
            [Display(Name = "Eai_Group", Description = "集团客户数据")]
            Eai_Group,
            [Display(Name = "FeeType", Description = "费用代码")]
            FeeType,
            [Display(Name = "FeeUnit", Description = "币制信息")]
            FeeUnit,
            [Display(Name = "Saller", Description = "销售")]
            Saller,
            /*------------------------------------------------End 基础资料*/
                                ...
                                if (str.IndexOf("System.Collections.") >= 0)
                                {
                                    ...
                                    if (_PropertyInfos.Any())
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            {
                                                string Split = "AirOut.Web.Models.";
        ...
        public static void AddError(Exception raisedException, NotificationTag notificationTag, string NotificationTagName)
        {
            ...
            if (httpContext != null)
            {
                ...
                try
                {
                    ...
                    EventLogHelper.RawWrite(notificationTag, NotificationTagName, controllerName, actionName, content, MessageType.Error);
                }
                catch (Exception ex)
                {
                    ErrMsg += " " + ex.Message;
        ...
        /// <returns></returns>
        public static List<AirOut.Web.Models.SetDefaults> getAllSetDefaultsByTable(string TableName = "")
        {
            string XMLPath = System.Configuration.ConfigurationManager.AppSettings["SetDefaultsXml"] ?? "/App_Data/SetDefaults.xml";
            List<AirOut.Web.Models.SetDefaults> ArrSetDefaults = new List<AirOut.Web.Models.SetDefaults>();
            AirOut.Web.Models.SetDefaults OSetDefaults = new AirOut.Web.Models.SetDefaults();
            if (TableName == "")
            {
                ArrSetDefaults = new List<AirOut.Web.Models.SetDefaults>();
            }
            else
            {
                try
                    ...
                    if (xmlTableNode != null)
                    {
                        if (xmlTableNode.HasChildNodes)
                        {
                            ...
                            if (xmlAutoSetNodes != null)
                            {
                                ...
                                {
                                    OSetDefaults = new AirOut.Web.Models.SetDefaults();
        ...
        public static void SetDefaultValueToModel(string TableName = "", Object TableClass = null)
        {
            ...
            if (TableClass == null)
                return;
            List<AirOut.Web.Models.SetDefaults> list = getAllSetDefaultsByTable(TableName);
            if (!list.Any())
                return;
                        ...
                        if (Arguments.Count() == 1)
                        {
                            ...
                            if (ChildType != null)
                            {
                                if (ChildType == typeof(DateTime) || ChildType == typeof(int) || ChildType == typeof(decimal) ||
                                    ChildType == typeof(double) || ChildType == typeof(float) || ChildType == typeof(bool))
                                {
                                    AirOut.Web.Extensions.Common.setProtityValue(SetobjModel, fi, GetObjVal);
                                }
                            }
                        }
                    }
                    //判断是否派生自IEnumerable(string 是特殊的数组)
                        ...
                        (fi.FieldType.Name.ToLower().IndexOf("[]") > 0 || fi.FieldType.Name.ToLower().IndexOf("<") > 0))))
                        {
                            ...
                            (argsType.Name.ToLower().IndexOf("[]") > 0 || argsType.Name.ToLower().IndexOf("<") > 0))))
                            {
                                ...
                                if (IsList)
                                {
                                    AirOut.Web.Extensions.Common.setProtityValue(SetobjModel, fi, ObjListT);
                                }
                                else
                                {
                                    ...
                                    if (ToArrayMethodInfo != null)
                                    {
                                        ...
                                        AirOut.Web.Extensions.Common.setProtityValue(SetobjModel, fi, ArrObj);
                                    }
                                }
                            }
                        ...
                        else if (fi.FieldType.IsClass && !fi.FieldType.IsPrimitive && fi.FieldType.Name.ToLower().IndexOf("string") < 0)
                        {
                            ...
                            AirOut.Web.Extensions.Common.setProtityValue(SetobjModel, fi, obj);
                        }
                        else
                        {
                            AirOut.Web.Extensions.Common.setProtityValue(SetobjModel, fi, GetObjVal);
        ...
        public static Type GetTypeByClassName(string ClassName)
        {
            ...
            #region 获取当前AirOut.Web.Models类的实例
        ...
        public static string ToJson(this DataTable dt)
        {
            ...
            javaScriptSerializer.MaxJsonLength = 1024000000; //取得最大数值
    ...
    public class MessageToRedis
    {
        ...
        /// LocalLog 存到本地
        /// </summary>
        public AirOut.Web.Extensions.Common.RedisLogMsgType ORedisLogMsgType { get; set; }
