...
namespace AirOut.Web.WebServiceHelper
{
    /// <summary>
    /// WebService加锁字段
    /// </summary>
    public static class WebServiceLockObj
    {
        ...
        public static ReaderWriterLock ORWLogLocker = AirOut.Web.Extensions.Common.ORWLogLocker; //new ReaderWriterLock();
    }
    ...
    public class WebServiceHandle
    {
        ...
        public Tuple<bool, object> GetData(ref object[] retObj, XmlDocument doc = null)
        {
            ...
            if (doc == null)
            {
                ...
                if (HttpContext.Current == null || HttpContext.Current.Server == null)
                    LoadPath = AirOut.Web.Extensions.Common.GetMapPath(ModelPath);
                else
            ...
            if (xmlMethodNode != null)
            {
                ...
                foreach (XmlNode ParamNode in ArrMethodParams)
                {
                    ...
                    foreach (XmlNode item in ArrSQLNode)
                    {
                        ...
                        {
                            Tuple<bool, object> retTuple = new Tuple<bool, object>(false, (object)"WebService模板" + WebServiceMethodName + "方法，获取数据失败(+" + AirOut.Web.Extensions.Common.GetExceptionMsg(ex) + "+)");
                            //EnventRetValid(retTuple);
                            return retTuple;
                        }
                    }
        ...
        private Tuple<bool, object> ValidDataIsOK(DataSet ds, DataRow[] rows, XmlNode TableNodel)
        {
            try
            {
                ...
                //转换为 动态类
                List<dynamic> Arrdynamic = AirOut.Web.Extensions.Common.TableToDynamic(rows);
            ...
            {
                Tuple<bool, object> exretTuple = new Tuple<bool, object>(false, AirOut.Web.Extensions.Common.GetExceptionMsg(ex));
                return exretTuple;
            }
        }
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(returnErrTypeStr))
                {
                    ...
                    if (retStr.Replace(" ", "").IndexOf(returnErrTypeStr.Replace("'", "\"")) >= 0 || retStr.Replace(" ", "").IndexOf(returnErrTypeStr.Replace("\"", "'")) >= 0)
                    {
                        ...
                        try
                        {
                            AirOut.Web.Extensions.Common.WriteLog_LocalByRWLogLocker(retStr, "ServiceLog\\ErrorReturn", true, false);
    ...
    public static class WebServiceHelper
    {
        ...
        private static object InvokeWebService(string url, string classname, string methodname, object[] args, OracleParameter[] Param_s, string _ModelPath, string UserName = "", string PasswordStr = "")
        {
            ...
            try
            {
                ...
                if (_ModelPath.IndexOf(":") <= 0)
                {
                    ...
                    if (HttpContext.Current == null || HttpContext.Current.Server == null)
                        _ModelPath = AirOut.Web.Extensions.Common.GetMapPath(XMLPath);
                    else
        ...
        private static Tuple<bool, object> InvokeWebServiceInMemeory(string url, string methodname, object[] args, OracleParameter[] Param_s, string _ModelPath, string UserName = "", string PasswordStr = "", string classname = "", string nameSpace = "WECDSWebService.DynamicWebCalling", string retErrTypeStr = "")
        {
            try
            {
                ...
                if (WebServiceType != null)
                {
                    ...
                    if (mi != null)
                    {
                        ...
                        {
                            AirOut.Web.Extensions.Common.WriteLog_LocalByRWLogLocker(MethodParamJsonObj, ServiceLogAddress, true, false, LabelStr, null, WebServiceLockObj.ORWLogLocker);
                            //WebServiceLockObj.ORWLogLocker.AcquireWriterLock(500);
            ...
            {
                //throw new Exception(ex.InnerException.Message, new Exception(ex.InnerException.StackTrace));
                Tuple<bool, object> retobj = new Tuple<bool, object>(false, (object)AirOut.Web.Extensions.Common.GetExceptionMsg(ex));
                return retobj;
            }
        }
        ...
        public static Tuple<bool, object> InvokeWebServiceOutPutDLL(string url, string methodname, object[] args, string _ModelPath, OracleParameter[] Param_s, string UserName = "", string PasswordStr = "", string classname = "", string retErrTypeStr = "")
        {
            ...
            try
            {
                ...
                if (_ModelPath.IndexOf(":") <= 0)
                {
                    ...
                    if (HttpContext.Current == null || HttpContext.Current.Server == null)
                        _ModelPath = AirOut.Web.Extensions.Common.GetMapPath(_ModelPath);
                    else
                ...
                if (WebServiceType != null)
                {
                    ...
                    if (mi != null)
                    {
                        ...
                        if (IsWriteServiceLog)
                        {
                            ...
                            {
                                //AirOut.Web.Extensions.Common.WriteLog_Local
                            }
                        }
                        ...
                        {
                            _Methodretobj = (object)AirOut.Web.Extensions.Common.GetExceptionMsg(ex);
                            IsInvokeErr = true;
                        }
                        //Invoke返回结果转换为Json
                        string MethodretobjStr = "";
                        ...
                        //                    AirOut.Web.Extensions.Common.WriteLog_LocalByRWLogLocker("发送邮件错误：" + ErrMsgStr + Newtonsoft.Json.JsonConvert.SerializeObject(MethodObj), "Mail//Error", true);
                        //                    //WebServiceLockObj.ORWLogLocker.AcquireWriterLock(500);
        ...
        public static void WirteLog(string subject, string key1, string key2, string content, string methodname, OracleParameter[] Param_s, AirOut.Web.Models.MessageType MsgType = AirOut.Web.Models.MessageType.Error)
        {
            try
            {
                string Key1_Str = "";
                ...
                var MessageRep = unitOfWork_.Repository<AirOut.Web.Models.Message>();
                string name = NotificationTag.WebService.ToString();
                var notification = NotificationRep.Queryable().Where(x => x.Name == name).FirstOrDefault();
                if (notification != null)
                {
                    AirOut.Web.Models.Message message = new AirOut.Web.Models.Message();
