...
namespace AirOut.Web
{
    public class BundleConfig
    {
        ...
        {
            BundleTable.EnableOptimizations = false;     // Added this 

            bundles.Add(new ScriptBundle("~/TypeScript_File").Include(
                      "~/TypeScript_File/index.js")); 
            ...
            //Uploadify v3.2.1
            bundles.Add(new StyleBundle("~/uploadify/css").Include(
                     "~/Scripts/uploadifive/uploadify.css"));

            bundles.Add(new ScriptBundle("~/uploadify/js").Include(
