    ...
    public class CacheHelper : GetKeyPerpoty
    {
        ...
        public static void GetSpecialCacheKey()
        {
            ...
            catch (Exception ex)
            {
                ...
                WriteLogHelper.WriteLog_Local(ErrMsg, LogFolder, true);
            }
        }
        ...
        /// <returns></returns>
        public static object Get_SetCache(Common.CacheNameS OCacheKey)
        {
            if (ArrSpecialCacheKey == null || !ArrSpecialCacheKey.Any())
                GetSpecialCacheKey();
            //特殊缓存键值，手动实现
        ...
        /// <param name="CacheName"></param>
        /// <returns></returns>
        public static bool? Get_SetBoolConfAppSettings(string logPath, string CacheName)
        {
            bool? retobj = null;
            try
            {
                ...
                if (HttpRuntime.Cache[CacheName] != null)
                    retobj = (bool)HttpRuntime.Cache[CacheName];
                if (retobj == null)
                {
            ...
            catch (Exception ex)
            {
                ...
                WriteLogHelper.WriteLog_Local(ErrMsg, logPath, true);
                retobj = null;
            }
            return retobj;
        }
        ...
        /// <param name="CacheName"></param>
        /// <returns></returns>
        public static string Get_SetStringConfAppSettings(string logPath, string CacheName)
        {
            string retobj = null;
            try
            {
        ...
        /// <param name="logPath"></param>
        /// <returns></returns>
        public static object Get_SetdbContextMember(ApplicationDbContext AppdbContext = null, string logPath = "", string CacheName = "dbContextMember")
        {
            MemberInfo[] ArrMember = new MemberInfo[] { };
            try
            {
