...
namespace CCBWebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            //    var ArrAuthenticationTypes = context.Authentication.GetAuthenticationTypes();
            ...
            //        identity.AddClaim(new Claim(ClaimTypes.Name, HttpContext.Current.Request["UserName"]));
            //        identity.AddClaim(new Claim(ClaimTypes.Role, "user"));
            //        if (AuthenticationType.AuthenticationType.IndexOf("cookie") > 0)
            //        {
            //            ClaimsPrincipal OClaimsPrincipal = new ClaimsPrincipal(identity);
            //            context.Request.User = OClaimsPrincipal;
            //        }
            ...
            //    //ClaimsIdentity cookieIdentity = new ClaimsIdentity(DefaultAuthenticationTypes.ApplicationCookie);
