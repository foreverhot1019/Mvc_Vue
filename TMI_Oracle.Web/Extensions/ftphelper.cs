...
namespace TMI.Web.Extensions
{
    ...
    public class FtpHelper
    {
        ...
        public string FTPServer
        {
            get;
            set;
            //{ return ConfigurationManager.AppSettings["FTPServer"] == "" ? "172.20.55.75" : ConfigurationManager.AppSettings["FTPServer"]; }
        }
        ...
        public string UserName
        {
            get;
            set;
            //{ return ConfigurationManager.AppSettings["FTPUserName"] == "" ? "ftpuser" : ConfigurationManager.AppSettings["FTPUserName"]; }
        }
        ...
        public string Password
        {
            get;
            set;
            //{ return ConfigurationManager.AppSettings["FTPPassword"] == "" ? "ftpuser" : ConfigurationManager.AppSettings["FTPPassword"]; }
        }

        /// <summary>
        /// ftp服务器端口号
        /// </summary>
        public int FTPPortNO
        {
            get;
            set;
            //return ConfigurationManager.AppSettings["FTPPortNO"] == "" ? 21 : int.Parse(ConfigurationManager.AppSettings["FTPPortNO"]);
        }
        ...
        public Uri Uri
        {
            get;
            set;
            //{ return new Uri("ftp://" + FTPServer + ":" + FTPPortNO); }
        }
        ...
        public FtpHelper(Uri uri, string username, string password, Encoding _Encode =null)
        {
            this.Uri = uri;
        ...
        private FtpWebRequest CreateRequest(Uri uri, string method)
        {
            try
            {
                ...
                request.KeepAlive = true;//指定连接是应该关闭还是在请求完成之后关闭，默认为true
        ...
        /// </summary>
        /// <param name="remoteFilePath">远程完整文件名</param>
        public byte[] GetFileStream(string remoteFilePath)
        {
            try
            {
                MemoryStream outputStream = new MemoryStream();
                FtpWebResponse response = CreateResponse(new Uri(this.Uri + remoteFilePath.Replace("\\", "/").Substring(1)), WebRequestMethods.Ftp.DownloadFile);
