...
namespace TMI.Web
{
    public class ExcelHelper
    {
        ...
        public static byte[] OutPutExcelByArrModel(Object ArrObjT)
        {
            ...
            string ModelsNameSpace = (string.IsNullOrEmpty(WebTop_NameSpace) || string.IsNullOrEmpty(_ModelsNameSpace)) ? "TMI.Web.Models" : WebTop_NameSpace + "." + _ModelsNameSpace;
        ...
        public static byte[] OutPutExcelByListModel<T>(T ObjT, string ExcelModelPath, int HeadLineRowIndex, int HeadLineCellsIndex, out string FilePath, string FileStartName)//List<obj>
        {
            ...
            string ModelsNameSpace = WebTop_NameSpace + "." + Models_NameSpace;//"TMI.Web.Models"
            string ModelsTopNameSpace = Top_NameSpace + ".";
            ...
            List<TMI.Web.Models.TotalColumn> ArrColumnTotal = new List<TMI.Web.Models.TotalColumn>();
                                ...
                                if (retVal != null)
                                {
                                    switch (DataType.ToLower())
                                    {
                                        case "int":
                                            ...
                                            {
                                                TMI.Web.Models.TotalColumn Temp = new TMI.Web.Models.TotalColumn();
                                        ...
                                        case "int32":
                                            ...
                                            {
                                                TMI.Web.Models.TotalColumn Temp32 = new TMI.Web.Models.TotalColumn();
                                        ...
                                        case "int64":
                                            ...
                                            {
                                                TMI.Web.Models.TotalColumn Temp64 = new TMI.Web.Models.TotalColumn();
                                        ...
                                        case "decimal":
                                            ...
                                            {
                                                TMI.Web.Models.TotalColumn Tempdecima = new TMI.Web.Models.TotalColumn();
                                        ...
                                        case "double":
                                            ...
                                            {
                                                TMI.Web.Models.TotalColumn Tempdouble = new TMI.Web.Models.TotalColumn();
                                        ...
                                        case "float":
                                            ...
                                            {
                                                TMI.Web.Models.TotalColumn Tempfloat = new TMI.Web.Models.TotalColumn();
        ...
        public static byte[] OutPutExcelByListModel<T>(T ObjT, bool MoreSheet, string ExcelModelPath, int HeadLineRowIndex, int HeadLineCellsIndex, out string FilePath, string FileStartName)//List<obj>
        {
            ...
            if (ExcelFile.Exists)
            {
                try
                {
                    ...
                    {
                        ArrColumnTotal = new List<TMI.Web.Models.TotalColumn>();
        ...
        public static byte[] OutPutExcelByListModel<T>(Object ObjT) where T : class,new()
        {
            ...
            try
            {
                ...
                foreach (PropertyInfo pi in basePi)
                {
                    ...
                    if (WhereGetPi.Any())
                    {
                        ColumnName = TMI.Web.Extensions.Common.GetMetaDataDisplayName(GetType, pi.Name);
                    }
                    else
                    {
                        ...
                        if (WhereGetPi.Any())
                        {
                            ColumnName = TMI.Web.Extensions.Common.GetMetaDataDisplayName(GetType, pi.Name.Replace("NAME", "")) + "名称";
                        }
                    }
                    //设置单元格 名称
