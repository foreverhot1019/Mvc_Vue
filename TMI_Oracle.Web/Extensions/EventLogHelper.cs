...
namespace TMI.Web
{
    ...
    {
        public static void RawWrite(TMI.Web.Models.EnumType.NotificationTag notificationTag, string subject, string key1, string key2, string content, TMI.Web.Models.EnumType.MessageType messageType)
        {
...
//            }
        ...
        public static void Write(TMI.Web.Models.EnumType.NotificationTag notificationTag, string subject, string key1, string key2, string content, TMI.Web.Models.EnumType.MessageType messageType)
        {
