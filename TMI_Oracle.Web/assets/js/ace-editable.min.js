...
!function (a)
{
    ...
    a.extend(b.prototype, {
        ...
        render: function ()
        {
            ...
            this.$file.off("file.error.ace").on("file.error.ace",
            function (b, c)
            {
...
function (a)
{
    ...
    a.extend(b.prototype, {
        render: function ()
        {
            ...
            this.$tpl.parent().find(".wysiwyg-editor").show().ace_wysiwyg(this.options.wysiwyg).prev().addClass("wysiwyg-style2").closest(".editable-input").addClass("editable-wysiwyg").closest(".editable-container").css({
                display: "block"
            }),
    ...
    a.extend(b.prototype, {
        ...
        activate: function ()
        {
            if (this.$input.is(":visible") && this.$input.focus(), this.nativeUI) this.$input.get(0).type = "date";
                ...
                {
                    b.show()
                }).siblings(".input-group-addon").on("click",
                function ()
                {
                    b.show()
                })
