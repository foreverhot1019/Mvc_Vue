...
{
    [MetadataType(typeof(FinanceMoneyMetadata))]
    public partial class FinanceMoney
    {
    }

    public partial class FinanceMoneyMetadata
    {
    ...
    public class FinanceMoneyChangeViewModel
    {
        public IEnumerable<FinanceMoney> inserted { get; set; }

        public IEnumerable<FinanceMoney> deleted { get; set; }

        public IEnumerable<FinanceMoney> updated { get; set; }
    }
}