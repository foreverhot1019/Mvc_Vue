...
{
    [MetadataType(typeof(ActualMoneyMetadata))]
    public partial class ActualMoney
    {
    }

    public partial class ActualMoneyMetadata
    {
    ...
    public class ActualMoneyChangeViewModel
    {
        public IEnumerable<ActualMoney> inserted { get; set; }

        public IEnumerable<ActualMoney> deleted { get; set; }

        public IEnumerable<ActualMoney> updated { get; set; }
    }
}
