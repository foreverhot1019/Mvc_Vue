...
namespace TMI.Web.Services
{
    public class MessageService : Service<Message>, IMessageService
    {
        ...
        public void Append(string name, string subject, string key, string content, TMI.Web.Models.EnumType.MessageType messageType)
        {
        ...
        public void Append(TMI.Web.Models.EnumType.NotificationTag notificationTag, string subject, string key1, string key2, string content, TMI.Web.Models.EnumType.MessageType messageType)
        {
