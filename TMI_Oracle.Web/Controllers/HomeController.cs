...
namespace TMI.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public void Test()
        {
            ...
            //var QMessage = _unitOfWork.Repository<TMI.Web.Models.Message>().Queryable().Where(x => x.NewDate.Month == DateTime.Now.Month).ToList();
            //var _Type = typeof(TMI.Web.Models.Message);
            ...
            //        try
            //        {
            //            TMI.Web.Models.WebdbContext NewAppContxt = new TMI.Web.Models.WebdbContext();
                        ...
                        if (Code == 200)
                        {
                            if (resData.data != null)
                            {
                                ...
                                if (!string.IsNullOrEmpty(picUrl))
                                {
                                    ...
                                    //var ArrEnumContentType = Common.GetEnumToDic("ContentType", "TMI.Web.Controllers",".");
        ...
        {
            List<string> ArrStr = null;
            return Json(new { Success = true, ArrNum = ArrStr.Count() }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            var ArrStatus = TMI.Web.Extensions.Common.GetEnumToDic(EnumName, "TMI.Web.Models.EnumType").
                Select(n => new
                {
                    ID = n.Value.ToString(),
                    TEXT = n.DisplayName,
